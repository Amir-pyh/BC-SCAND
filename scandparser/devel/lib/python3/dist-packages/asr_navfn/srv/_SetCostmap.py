...
"""autogenerated by genpy from asr_navfn/SetCostmapRequest.msg. Do not edit."""
import codecs
import sys
...
class SetCostmapRequest(genpy.Message):
  ...
  _type = "asr_navfn/SetCostmapRequest"
...
def _get_struct_2H():
    ...
    return _struct_2H
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from asr_navfn/SetCostmapResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class SetCostmapResponse(genpy.Message):
  ...
  _type = "asr_navfn/SetCostmapResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """"""
  __slots__ = []
  _slot_types = []
