...
(cl:defmethod cl:initialize-instance :after ((m <SetCostmap-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetCostmap-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name asr_navfn-srv:<SetCostmap-request> is deprecated: use asr_navfn-srv:SetCostmap-request instead.")))

(cl:ensure-generic-function 'costs-val :lambda-list '(m))
(cl:defmethod costs-val ((m <SetCostmap-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader asr_navfn-srv:costs-val is deprecated.  Use asr_navfn-srv:costs instead.")
  (costs m))

(cl:ensure-generic-function 'height-val :lambda-list '(m))
(cl:defmethod height-val ((m <SetCostmap-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader asr_navfn-srv:height-val is deprecated.  Use asr_navfn-srv:height instead.")
  (height m))

(cl:ensure-generic-function 'width-val :lambda-list '(m))
(cl:defmethod width-val ((m <SetCostmap-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader asr_navfn-srv:width-val is deprecated.  Use asr_navfn-srv:width instead.")
  (width m))
...
(cl:defmethod cl:initialize-instance :after ((m <SetCostmap-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetCostmap-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name asr_navfn-srv:<SetCostmap-response> is deprecated: use asr_navfn-srv:SetCostmap-response instead.")))
