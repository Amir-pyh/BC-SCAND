...
(cl:defmethod cl:initialize-instance :after ((m <MakeNavPlan-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MakeNavPlan-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name asr_navfn-srv:<MakeNavPlan-request> is deprecated: use asr_navfn-srv:MakeNavPlan-request instead.")))

(cl:ensure-generic-function 'start-val :lambda-list '(m))
(cl:defmethod start-val ((m <MakeNavPlan-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader asr_navfn-srv:start-val is deprecated.  Use asr_navfn-srv:start instead.")
  (start m))

(cl:ensure-generic-function 'goal-val :lambda-list '(m))
(cl:defmethod goal-val ((m <MakeNavPlan-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader asr_navfn-srv:goal-val is deprecated.  Use asr_navfn-srv:goal instead.")
  (goal m))
...
(cl:defmethod cl:initialize-instance :after ((m <MakeNavPlan-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MakeNavPlan-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name asr_navfn-srv:<MakeNavPlan-response> is deprecated: use asr_navfn-srv:MakeNavPlan-response instead.")))

(cl:ensure-generic-function 'plan_found-val :lambda-list '(m))
(cl:defmethod plan_found-val ((m <MakeNavPlan-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader asr_navfn-srv:plan_found-val is deprecated.  Use asr_navfn-srv:plan_found instead.")
  (plan_found m))

(cl:ensure-generic-function 'error_message-val :lambda-list '(m))
(cl:defmethod error_message-val ((m <MakeNavPlan-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader asr_navfn-srv:error_message-val is deprecated.  Use asr_navfn-srv:error_message instead.")
  (error_message m))

(cl:ensure-generic-function 'path-val :lambda-list '(m))
(cl:defmethod path-val ((m <MakeNavPlan-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader asr_navfn-srv:path-val is deprecated.  Use asr_navfn-srv:path instead.")
  (path m))
